...
const api: KimiAgentDesktopApi = {
  ...
  setSessionSwarmMode: (sessionId, enabled) =>
    ipcRenderer.invoke(ipcChannels.sessionSwarmModeSet, sessionId, enabled),
  setSessionTowerMode: (sessionId, enabled) =>
    ipcRenderer.invoke(ipcChannels.sessionTowerModeSet, sessionId, enabled),
  getTowerPreference: () => ipcRenderer.invoke(ipcChannels.towerPreferencesGet),
  setTowerPreference: (enabled) => ipcRenderer.invoke(ipcChannels.towerPreferencesSet, enabled),
  ...
  suggestWorkspaceFiles: (workspaceId, query) => ipcRenderer.invoke(ipcChannels.filesSuggest, workspaceId, query),
  ...
  inheritSecondaryModel: () => ipcRenderer.invoke(ipcChannels.settingsSecondaryModelInherit),
  ...
  updateKimiProvider: (input) => ipcRenderer.invoke(ipcChannels.providerUpdate, input),
  deleteKimiProvider: (providerId) => ipcRenderer.invoke(ipcChannels.providerDelete, providerId),
  ...
  listManagedMcpServers: () => ipcRenderer.invoke(ipcChannels.mcpManagedServersList),
  addManagedMcpServer: (input) => ipcRenderer.invoke(ipcChannels.mcpManagedServerAdd, input),
  replaceManagedMcpServer: (name, config) => ipcRenderer.invoke(ipcChannels.mcpManagedServerReplace, name, config),
  deleteManagedMcpServer: (name) => ipcRenderer.invoke(ipcChannels.mcpManagedServerDelete, name),
  testMcpServer: (input) => ipcRenderer.invoke(ipcChannels.mcpManagedServerTest, input),
  inspectMcpServers: () => ipcRenderer.invoke(ipcChannels.mcpManagedServersInspect),
  beginMcpAuth: (name) => ipcRenderer.invoke(ipcChannels.mcpAuthBegin, name),
  completeMcpAuth: (flowId) => ipcRenderer.invoke(ipcChannels.mcpAuthComplete, flowId),
  cancelMcpAuth: (flowId) => ipcRenderer.invoke(ipcChannels.mcpAuthCancel, flowId),
  resetMcpAuth: (name) => ipcRenderer.invoke(ipcChannels.mcpAuthReset, name),
