...
const enUS: Record<string, string> = {
  ...
  '重新运行': 'Retry',
  '正在重新运行…': 'Retrying…',
  '重新运行最近一次任务': 'Rerun the last task',
  '最近一次消息无法重新发送': 'The last message cannot be resent',
  ...
  'Plan 查看': 'Plan review',
  '完整计划': 'Full plan',
  '审批与反馈': 'Review & feedback',
  '待审批': 'Pending',
  '已批准': 'Approved',
  '已拒绝': 'Rejected',
  '选择项：': 'Selected: ',
  '可选操作：': 'Available actions: ',
  '暂无计划文本 —— 等 adapter 从 `plan_review` / `/transcript/plan` 投影后展示。': 'Plan text is not yet available — it will appear once the adapter projects `plan_review` / `/transcript/plan`.',
  '暂无审批记录。': 'No review records yet.',
  '计划反馈…': 'Plan feedback…',
  '计划反馈': 'Plan feedback',
  '复制计划': 'Copy plan',
  '已复制': 'Copied',
  '发送反馈': 'Send feedback',
  '关闭计划查看器': 'Close plan viewer',
  '查看计划': 'View plan',
