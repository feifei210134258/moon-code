...
17. [ADR-0001：使用 Kimi 官方 Server API](./adr/0001-use-kimi-server-api.md)
18. [ADR-0002：Electron + Vue 桌面架构](./adr/0002-electron-vue-desktop.md)
19. [ADR-0003：Kimi 数据为唯一事实源](./adr/0003-kimi-data-source-of-truth.md)
20. [ADR-0004：Kimi 0.29 v2 Terminal 兼容层](./adr/0004-kimi-v2-terminal-compatibility.md)
21. [ADR-0005：Kimi 0.29 v2 Provider 变更边界](./adr/0005-kimi-v2-provider-mutation-boundary.md)
22. [ADR-0006：Skills、MCP 与 Agent roster 事实源](./adr/0006-kimi-skills-mcp-agent-projection.md)
